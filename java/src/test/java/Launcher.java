...
//                "\r\n",
        ...
        for (String s : test) {
            ParseResult ret = ParseMsg(s.getBytes(), s.length());
            if (ret.msg != null) {
                System.out.println("SIP msg parse success, total " + s.length() + ", check " + ret.checkLen + " bytes" +
                        ".");
                System.out.println(ret.msg.toString());
            }
            else {
                System.out.println("SIP msg parse fail, total " + s.length() + ", check " + ret.checkLen + " bytes.");
            }
        }
    }
